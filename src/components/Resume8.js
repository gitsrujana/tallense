    ...
    <>
      ...
      >
        ...
        <Stack direction="row">
          ...
          />
          <Typography
            sx={{ marginTop: "1%", marginLeft: "1%", fontFamily: "monospace" }}
          >
            summary
          </Typography>
          <Divider
        ...
        <Stack direction="row">
          ...
          />
          <Typography
            sx={{ marginTop: "1%", marginLeft: "1%", fontFamily: "monospace" , fontWeight:"bold"}}
          >
           skills
          </Typography>
          <Divider
          ...
          />
          <Typography
            sx={{ marginTop: "1%", fontWeight:"bold",marginLeft: "1%", fontFamily: "monospace" ,fontSize:"15px"}}
          >
            Education 
          </Typography>
          <Divider
