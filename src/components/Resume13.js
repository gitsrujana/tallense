  ...
  return (
    <>
      ...
      >
        ...
        >
          <Stack direction='row'>
            <HorizontalRuleIcon sx={{color:"white",marginLeft:"40%",marginTop:"3%"}}/>
            <Typography
              sx={{
                fontWeight: "bold",
                textAlign: "center",
            ...
            >
              ...
              SB
            </Typography><HorizontalRuleIcon sx={{marginTop:"3%",color:"white"}}/>
        ...
        <Stack
          direction="row"
          sx={{ marginTop: "-1%", backgroundColor: "#b30000" }}
        >
          <Typography
            sx={{
              fontSize: "12px",
              marginLeft: mediaViewPort ? "25%" : "12%",
              color: "white",
            }}
          >
            {resume11data.email}
        ...
        <Grid container>
          ...
          >
            <Typography
              sx={{ fontWeight: "bold", fontSize: "13px", marginTop: "5%" }}
            >
              SUMMARY
            </Typography>
            <Typography sx={{ fontSize: "12px", marginTop: "3%" }}>
            ...
            <Typography
              sx={{ fontSize: "12px", fontWeight: "bold", marginTop: "2%" }}
            >
            ...
            <Typography
              sx={{ fontSize: "12px", marginTop: "2%", fontWeight: "bold" }}
            >
            ...
            <Typography
              sx={{ fontWeight: "bold", fontSize: "13px", marginTop: "7%" }}
            >
              HOBBIES
            </Typography>
